(function () {
  ...
  */
  function isOperatorValid(operador) {
    return !!(propriedade[operador]); //fazer validação direto do undefined
  }
  console.log(isOperatorValid('x'), isOperatorValid('+'), isOperatorValid('-'), isOperatorValid('*'), isOperatorValid('/'), isOperatorValid('%'))
  ...
  */
  function calculator(operador) {
    return !isOperatorValid(operador) ? false : function (num1, num2) { //se cai no if quer dizer que é verdadeiro, logo não precisa comparar
      return typeof num1 !== 'number' || typeof num2 !== 'number' ? false :
        propriedade[operador](num1, num2);
    };
  }
  ...
  */
  !sum ? console.log(showErrorMessage(operationSignal)) : ( //quando for pra verificar a validade de uma função usa ela sem executar
    number1 = 1,
    number2 = 2,
  ...
  */
  ...
  !subtraction ? console.log(showErrorMessage(operationSignal)) : (
    number1 = 1,
    number2 = 2,
  ...
  !multiplication ? console.log(showErrorMessage(operationSignal)) : (
    number1 = 1,
    number2 = 2,
  ...
  !division ? console.log(showErrorMessage(operationSignal)) : (
    number1 = 1,
    number2 = 2,
  ...
  !mod ? console.log(showErrorMessage(operationSignal)) : (
    number1 = 1,
    number2 = 2,
