...
*/
(function allCode() { //minha ife não precisa ter nome
  ...
  */
  function calculator(number1, number2) {
    return function respoCalculator(callback) {
  ...
  */
  console.log('O resultado da soma é:',
    sum(function (x, y) { //fução anônima
      return x + y;
    })
  );
  ...
  */
  ...
  chamada.
  */
  console.log('O resultado da subtração é:', //não precisa colocar dois console log em seguida do outro, basta colocar vírgula
    subtraction(function soma(x, y) {
      return (x - y);
    })
  );

  console.log('O resultado da multiplicação é:',
    multiplication(function soma(x, y) {
      return (x * y);
    })
  );

  console.log('O resultado da divisão é:',
    division(function soma(x, y) {
      return (x / y);
    })
  );

  console.log('O resto da divisão é:',
    mod(function soma(x, y) {
      return (x % y);
    })
  );
